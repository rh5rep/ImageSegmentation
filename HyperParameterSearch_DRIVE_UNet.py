...
def hyperparameter_search(model, modeltype, device, dataset_train, dataset_validation, dataset_test, hyperparameter_grid, missing_hp, run_dir):
    ...
    run_counter = 0
    modeltype_directory = os.path.join(run_dir, "DRIVE")
...
hyperparameters = {
    ...
    'network name': 'HP_Search_DRIVE_UNet_1', 
    'dataset': 'DRIVE',
    'beta1': 0.9, 
    'beta2': 0.999, 
    'epsilon': 1e-08, 
...
hyperparameter_grid = {
    ...
    'gamma': [0.8, 0.9],
    'loss': [bce_loss, dice_loss, cross_entropy_loss, cross_entropy_weighted_loss, focal_loss], 
    }
